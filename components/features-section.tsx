...
import { Battery, Gauge, Shield, Wifi, Moon, Volume2 } from "lucide-react"

const features = [
  {
    icon: Battery,
    title: "All-Day Battery",
    description: "120km range on a single charge. Fast charging gets you 80% in just 45 minutes.",
  },
  {
    icon: Gauge,
    title: "45 km/h Top Speed",
    description: "Class-leading acceleration with intelligent speed limiting for legal compliance.",
  },
  {
    icon: Shield,
    title: "Theft Protection",
    description: "Built-in GPS tracking, remote lock, and instant alerts if your bike is moved.",
  },
  {
    icon: Wifi,
    title: "Always Connected",
    description: "LTE connectivity for real-time tracking, OTA updates, and crash detection.",
  },
  {
    icon: Moon,
    title: "Adaptive Lighting",
    description: "Automatic headlight and taillight adjust brightness based on ambient conditions.",
  },
  {
    icon: Volume2,
    title: "Silent Drive",
    description: "Belt-driven motor produces less than 30dB. Ride in peaceful silence.",
  },
]
    ...
    <section id="features" className="bg-black py-24 md:py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Smart features that make every journey effortless.
          </motion.p>
        </motion.div>
