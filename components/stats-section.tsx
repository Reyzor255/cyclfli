...
const stats = [
  { value: 8.2, unit: "kg", label: "Total Weight", decimals: 1 },
  { value: 85, unit: "Nm", label: "Motor Torque", decimals: 0 },
  { value: 120, unit: "km", label: "Max Range", decimals: 0 },
  { value: 45, unit: "km/h", label: "Top Speed", decimals: 0 },
]
