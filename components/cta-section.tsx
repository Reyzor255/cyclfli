        ...
        >
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white/30 text-white bg-transparent hover:bg-white/10 hover:border-white/50 text-lg px-12 py-7 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]"
            >
              Book a Test Ride
            </Button>
          </motion.div>
