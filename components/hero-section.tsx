    ...
    >
      ...
      <motion.div style={{ y, opacity, scale }} className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight leading-none mb-6 text-balance"
        >
        ...
        >
          ...
          <Button
            ...
            onClick={() => window.open('/netflixvideo.mp4', '_blank')}
          >
