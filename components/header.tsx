    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        >
          <Button
            variant="outline"
            className="border-[#E50914] text-[#E50914] bg-transparent hover:bg-[#E50914] hover:text-white transition-all duration-300 hover:shadow-[0_0_25px_rgba(229,9,20,0.4)]"
          >
            Pre-Order
          </Button>
        </motion.div>
          ...
          >
            <div className="flex flex-col items-center gap-6 py-8">
              ...
              >
                <Button
                  variant="outline"
                  className="border-[#E50914] text-[#E50914] bg-transparent hover:bg-[#E50914] hover:text-white transition-all duration-300"
                >
                  Pre-Order
                </Button>
              </motion.div>
